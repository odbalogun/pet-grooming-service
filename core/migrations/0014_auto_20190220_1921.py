# Generated by Django 2.1.4 on 2019-02-20 18:21
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='products',
            name='barcode',
            field=models.CharField(max_length=50, null=True, verbose_name='barcode'),
        ),
        migrations.AlterField(
            model_name='products',
            name='sku',
            field=models.CharField(max_length=100, null=True, verbose_name='sku'),
        ),
        migrations.AddField(
            model_name='productvariants',
            name='product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='variants', to='core.Products'),
        ),
    ]
