# Generated by Django 2.1.4 on 2019-03-01 09:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_duration', models.IntegerField(verbose_name='total duration')),
                ...
                ('total_price', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='USD', max_digits=10, verbose_name='total price')),
                ...
                ('customer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='bookings', to='core.Customers')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True, verbose_name='active')),
                ('delete_status', models.BooleanField(default=False, verbose_name='deleted')),
                ('booking', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='services', to='core.Bookings')),
                ('pet', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='services', to='core.BookingPets')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='services',
            name='price',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='USD', max_digits=10, verbose_name='price'),
        ),
        migrations.AddField(
            model_name='services',
            name='price_currency',
        ...
        migrations.AddField(
            model_name='bookingproducts',
            name='booking',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='products', to='core.Bookings'),
        ),
        migrations.AddField(
            model_name='bookingproducts',
            name='product',
        ...
        migrations.AddField(
            model_name='bookingproducts',
            name='variant',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.ProductVariants'),
        ),
        migrations.AddField(
            model_name='bookingpets',
            name='booking',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pets', to='core.Bookings'),
        ),
        migrations.AddField(
            model_name='bookingpets',
            name='pet',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.CustomerPets'),
        ),
    ]
